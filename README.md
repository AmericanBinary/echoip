...
![Build Status](https://github.com/AmericanBinary/echoip/workflows/build/badge.svg)
...
`go install github.com/AmericanBinary/echoip/...@latest`
...
Hub](https://hub.docker.com/r/AmericanBinary/echoip), which can be downloaded with:

`docker pull AmericanBinary/echoip`
